...
``` sh
$ npm install --save deckr-sharing
```
...
``` scss
@import "deckr-sharing/main";
```

## Security

If you discover any security sharing issues, please email support@interconectit.com instead of using the issue tracker.
